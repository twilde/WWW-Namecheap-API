...
WWW::Namecheap::SSL - Namecheap API SSL methods
...
Namecheap API SSL methods.

Perhaps a little code snippet.

    use WWW::Namecheap::SSL;

    my $foo = WWW::Namecheap::SSL->new();
    ...
